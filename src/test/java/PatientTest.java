...
public class PatientTest {
  ...
  public void equals_returnTrueIfNamesAreTheSame() {
    Patient firstPatient = new Patient("John Doe", "January 1, 1965", 1);
    Patient secondPatient = new Patient("John Doe", "January 1, 1965", 1);
    assertEquals(true, firstPatient.equals(secondPatient));
  }

  @Test
  public void getName_returnsCorrectName(){
    Patient newPatient = new Patient("John Doe", "January 1, 1965", 1);
